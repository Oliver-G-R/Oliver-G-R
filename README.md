...
<p align="center">
  Te invito a que te pases por mis repositorios y veas las cosas nuevas que he logrado 💯.
</p>

<p align="center">Pero antes de eso... un poco sobre mí 😉.</p>   
  

<img width="22%" align="right" src="https://media0.giphy.com/media/RJzm826vu7WbJvBtxX/giphy.gif" />  
...
import { Me } from './Mexico'; 

export const About = () => 
  Me.map(({specialty, working, country, hobby, ❤}) => (
    <div>
      <h1> Mi nombre es Oliver, soy de México </h1>
      
      <p>
        Mi especialidad es el desarrollo web 🌐 trabajando con React ⚛️, aunque actualmente
        me está llamando mucho el desarrollo móvil 📱. 
        Creo que pronto empezare a desarrollar algunos proyectos 🤔.
      </p>
      
      <h2>Actualmente trabjo en...</h2>
      <p>
        Colaboración con un amigo creando una página web usando 
        las tecnologías disponibles de forma nativa. 
        Creando web components, utilizando metodologías de estilo y desarrollo. 
      </p>
      
      <h2>Hobby</h2>
      <p>
        Normalmente estoy programando, buscando tecnologías nuevas para aprender,
        sino viendo series o Películas en Netflix 🍿, de vez en cuando jugando.
        Lo sé, soy aburrido 😕, pero la mayor parte de mi tiempo me la paso solo,
        así que no hay mucho que hacer.
      </p>
     
      <h2>Habilidades</h2>
     <p>
        Creo que todos tenemos muchas, la mía es enseñar, me gusta aprender y enseñar 
        a los demás lo que he logrado y aprendido.
        También he dado algunas clases sobre programación, hecho trabajos para mi instituto
        y ayudado a una que otra persona por ahí.
      </p>
      
      <p>
        Dejando de lado un poco lo que me gusta hacer, he dominado tecnologías importantes que 
        me han ayudado a poder seguir adelante con mi camino de aprendizaje.
      </p>   
    </div>
  ));
```
...
## Algunas Skills
<img width="20%" align="left" src="https://i.pinimg.com/originals/59/87/1c/59871c7fb4ca4d906e9ef1f4566cd378.gif" />
